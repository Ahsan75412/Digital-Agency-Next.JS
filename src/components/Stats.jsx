        ...
        <div className="bg-[#FFFFFF] grid gap-4 md:grid-cols-3  lg:grid-cols-4 py-12">
            <div className="stats shadow ">
                <div className="stat">
                    ...
                    <div className="stat-value text-center">{data.followers}</div>
            ...
            <div className="stats shadow ml-3">
                <div className="stat">
                    ...
                    <div className="stat-value text-center">{data.solved}</div>
            ...
            <div className="stats shadow ml-3">
                <div className="stat">
                    ...
                    <div className="stat-value text-center">{data.customers}</div>
            ...
            <div className="stats shadow ml-3">
                <div className="stat">
                    ...
                    <div className="stat-value text-center">{data.projects}</div>
